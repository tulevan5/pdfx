#include "include/pdf_renderer/pdf_renderer_plugin.h"
...
class PdfRendererPlugin : public flutter::Plugin {
 public:
  static void RegisterWithRegistrar(flutter::PluginRegistrarWindows* registrar);

  PdfRendererPlugin();

  virtual ~PdfRendererPlugin();
...
// static
void PdfRendererPlugin::RegisterWithRegistrar(
  ...
  auto plugin = std::make_unique<PdfRendererPlugin>();
...
void PdfRendererPlugin::HandleMethodCall(
    const flutter::MethodCall<flutter::EncodableValue>& method_call,
    std::unique_ptr<flutter::MethodResult<flutter::EncodableValue>> result) {
  ///
  ...
  if (method_call.method_name().compare(kOpenDocumentAssetMethod) == 0) {
    ...
    try {
      ...
      result->Error("pdf_renderer_exception", e.what());
    }
  }
  ...
  ///
    ...
    if (vDocId == arguments->end()) {
      result->Error("pdf_renderer_exception", "documentId is required");
      return;
    }
    ...
    if (vPageIndex == arguments->end()) {
      result->Error("pdf_renderer_exception", "page is required");
      return;
    }
  ...
  ///
    ...
    if (vPageId == arguments->end()) {
      result->Error("pdf_renderer_exception", "pageId is required");
      return;
    }
    ...
    if (vHeight == arguments->end()) {
      result->Error("pdf_renderer_exception", "height is required");
      return;
    }
    ...
    if (vWidth == arguments->end()) {
      result->Error("pdf_renderer_exception", "width is required");
      return;
    }
    ...
    if (vBackground == arguments->end()) {
      result->Error("pdf_renderer_exception", "backgroundColor is required");
      return;
    }
    ...
    switch (formatInt) {
      ...
      case 1:
        ...
        break;
      default:
        result->Error("pdf_renderer_exception",
    ...
    if (vCrop == arguments->end()) {
      result->Error("pdf_renderer_exception", "crop is required");
      return;
    }
    ...
    if (crop) {
      ...
      if (vCropX == arguments->end()) {
        result->Error("pdf_renderer_exception", "crop_x is required");
        return;
      }
      ...
      if (vCropY == arguments->end()) {
        result->Error("pdf_renderer_exception", "crop_y is required");
        return;
      }
      ...
      if (vCropWidth == arguments->end()) {
        result->Error("pdf_renderer_exception", "crop_width is required");
        return;
      }
      ...
      if (vCropHeight == arguments->end()) {
        result->Error("pdf_renderer_exception", "crop_height is required");
        return;
      }
...
void PdfRendererPluginRegisterWithRegistrar(
    FlutterDesktopPluginRegistrarRef registrar) {
  pdf_renderer::PdfRendererPlugin::RegisterWithRegistrar(
